...
for layer_size in [1,5,10,50,100]:
    nn = NeuralNetwork(mini_batch_size=32, n_features=1024, hidden_layers=[layer_size], n_classes=36, learning_rate=0.01)
    print(f"Training NN with hidden layer size: {layer_size}")
    ...
    with open(f"{output_path}/output_hidden_{layer_size}.txt", "w") as f:
